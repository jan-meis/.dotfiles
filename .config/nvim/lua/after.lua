...
local lsp_attach = function(client, bufnr)
  ...
  vim.keymap.set('n', 'gr', '<cmd>lua vim.lsp.buf.references()<cr>', {buffer = bufnr, desc = "Show occurrences of this object"})
  ...
  vim.keymap.set('n', '<leader>o', '<cmd>lua vim.diagnostic.open_float()<cr>', {buffer = bufnr, desc = "Open diagnostic"})
  vim.keymap.set('n', '<leader>gn', '<cmd>lua vim.diagnostic.goto_next()<cr>', {buffer = bufnr, desc = "Go to next diagnostic"})
  vim.keymap.set('n', '<leader>gp', '<cmd>lua vim.diagnostic.goto_prev()<cr>', {buffer = bufnr, desc = "Go to previous diagnositc"})
  vim.keymap.set('n', '<leader>sqf', '<cmd>lua vim.diagnostic.setqflist()<cr>', {buffer = bufnr, desc = "Set quickfix list"})
end
